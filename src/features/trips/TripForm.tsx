...
export function TripForm() {
  ...
  // Builds a Trip-shaped object from the current (possibly unsaved) form state so
  // printing reflects in-progress edits, then delegates to the util shared with
  // the Trip Dashboard's per-row print action.
  const handlePrintTrip = () => {
    ...
    const opened = printTripManifest(tripForPrint, invoices, trucks);
    if (!opened) {
