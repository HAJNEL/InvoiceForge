          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between gap-2">
              ...
              <select
                ...
                className="text-xs bg-zinc-50 border border-zinc-200 rounded-lg px-2 py-1 font-bold text-zinc-700 outline-none cursor-pointer hover:bg-zinc-100 transition-all"
              >
